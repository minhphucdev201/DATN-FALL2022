      ...
      <div className="content">
        <Container>
            ...
            <div className="content__box">
              <ul className="content__list">
                <li className="content__list--item">
                  Cung cấp các dịch vụ, thông tin sản phẩm đến Người Tiêu Dùng;
                </li>
                <li className="content__list--item">
                  Gửi các thông báo về các hoạt động trao đổi thông tin giữa Người Tiêu Dùng và
                  Hafos;
                </li>
                <li className="content__list--item">
                  Ngăn ngừa các hoạt động phá hủy, chiếm đoạt tài khoản người dùng của Người Tiêu
                  Dùng hoặc các hoạt động giả mạo Người Tiêu Dùng;
                </li>
                <li className="content__list--item">
                  Liên lạc và giải quyết khiếu nại với Người Tiêu Dùng;
                </li>
                <li className="content__list--item">
                  Xác nhận và trao đổi thông tin về giao dịch của Người Tiêu Dùng tại Hafos;
                </li>
                <li className="content__list--item">
          ...
          <div className="content__item">
            ...
            <p className="content__item--txt">
              Không có thời hạn ngoại trừ trường hợp Người Tiêu Dùng gửi có yêu cầu hủy bỏ tới cho
          ...
          <div className="content__item">
            ...
            <p className="content__item--txt">
              Người Tiêu Dùng đồng ý rằng, trong trường hợp cần thiết, các cơ quan/ tổ chức/cá nhân
              sau có quyền được tiếp cận và thu thập các thông tin cá nhân của mình, bao gồm:
            </p>
            <div className="content__box">
              <ul className="content__list">
          ...
          <div className="content__item">
            ...
            <p className="content__item--txt">
              ...
              nhân của Người Tiêu Dùng khi không có sự đồng ý của Người Tiêu Dùng ngoại trừ các
            ...
            <p className="content__item--txt">
              ...
              cá nhân của Người Tiêu Dùng, Ban quản trị có trách nhiệm thông báo và làm việc với cơ
              quan chức năng điều tra và xử lý kịp thời, đồng thời thông báo cho Người Tiêu Dùng
              được biết về vụ việc.
            </p>
            <p className="content__item--txt">
              Bảo mật tuyệt đối mọi thông tin giao dịch trực tuyến của Người Tiêu Dùng bao gồm thông
              tin hóa đơn kế toán chứng từ số hóa tại. 8. CƠ CHẾ TIẾP NHẬN VÀ GIẢI QUYẾT KHIẾU NẠI
              LIÊN QUAN ĐẾN VIỆC THÔNG TIN CỦA NGƯỜI TIÊU DÙNG
            </p>
          </div>
          <p>&nbsp;</p>
          <div className="content__item">
            ...
            <p className="content__item--txt">
              Khi phát hiện thông tin cá nhân của mình bị sử dụng sai mục đích hoặc phạm vi, Người
              Tiêu Dùng gửi email khiếu nại đến email hafos.vn@gmail.com hoặc gọi điện thoại tới số
              0937 141 663 để khiếu nại và cung cấp chứng cứ liên quan tới vụ việc cho Ban quản trị.
              Ban quản trị cam kết sẽ phản hồi ngay lập tức hoặc muộn nhất là trong vòng 24 (hai
              mươi tư) giờ làm việc kể từ thời điểm nhận được khiếu nại.
            </p>
            <p>&nbsp;</p>
          </div>
        </Container>
